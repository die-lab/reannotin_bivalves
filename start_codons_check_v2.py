...
#difference from version one? THIS TIME EVERY POSITION IS CONSIDERED, AND NOT ONLY A THIRD OF IT (SO NOT AS THEY WERE CODONS POSITION)
...
def plot_start(alternative_dict, gene, heigth, weird, notes, no_notes):
	...
	ax.set_title(str(genbank_file.strip('.gb').strip('/.') + ' ' + gene + ' alternative start codons distribution'))
