...
def plot_start(alternative_dict, gene, heigth, weird, no_notes):
	start_counts = {}
...
for gene in mito_genes:
	...
	for file in gene_files:
		...
		if cot[0] == 1:
			if record.id not in notes_dict[gene]:
	...
	print(weird_length_fraction, max(length_tot), no_notes_about)
	...
	plot_start(alternative_dict,gene,len(gene_files),weird_length,no_notes_about)
